...
public class OverlayRenderer
{
    ...
    public static void renderOverlays(Matrix4f positionMatrix, Matrix4f projMatrix, MinecraftClient mc)
    {
        ...
        RenderContainer.INSTANCE.render(entity, positionMatrix, projMatrix, mc);
    }
